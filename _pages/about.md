...
\[53\] Musen Zhang, Yuxuan Liu, Yunfei Luan, Jinkai Li, and **Yao Guo\***, "Towards Robust Egocentric Object Tracking: A Plug-and-Play Trajectory-Aware Approach", _**IEEE Transactions on Mobile Computing (TMC)**_, Accepted, **2026**. (\*Corresponding author)

\[52\] Yating Luo, Yuxuan Liu, Yunfei Luan, **Yao Guo\***, and Guang-Zhong Yang\*, "A Hierarchical Learning Framework for Micro-Electrode Manipulation under Microscopic Vision", _**IEEE/ASME Transactions on Mechatronics (TMECH)**_, Accepted, **2026**. [\[Paper\]](https://ieeexplore.ieee.org/document/11561778) (\*Co-corresponding author)

[51] Xinyao Zhou, Yuxuan Liu, Yating Luo, Yunfei Luan, Guang-Zhong Yang, and **Yao Guo\***, "Wrist Camera Pose-Guided Multi-View Fusion for Occlusion Reconstruction in Robot-Assisted Microsurgical Anastomosis", _**International Conference on Medical Image Computing and Computer-Assisted Intervention (MICCAI)**_, Strasbourg, France, Accepted, **2026**. (\*Corresponding author)

[50] Yunfei Luan, Yuxuan Liu, Yuyang Zhuge, Yating Luo, **Yao Guo\***, and Guang-Zhong Yang\*, "One-Shot Autofocus Via User-Adaptive Gaze Control for Robot-Assisted Microsurgery", _**IEEE International Conference on Robotics and Automation (ICRA)**_, Vienna, Austria, Accepted, **2026**. (\*Co-corresponding author, <span style="color:red">**Finalists of Best Paper Award in Medical Robotics**</span>)

[49] Yuxuan Liu, Yuyang Zhuge, Xinyao Zhou, Yating Luo, Yunfei Luan, **Yao Guo\***, and Guang-Zhong Yang\*, "Cross-View Exocentric and Egocentric Fusion for Robust Microsurgical Anastomosis Understanding", _**IEEE International Conference on Robotics and Automation (ICRA)**_, Vienna, Austria, Accepted, **2026**. (\*Co-corresponding author)

[48] Yuxuan Liu, Xinyao Zhou, Yating Luo, Yunfei Luan, Zhennan Xiao, **Yao Guo\***, and Guang-Zhong Yang\*, "Simultaneous Surgical Stereo Depth and Motion Estimation via Brightness-Aware Self-Supervised Learning", _**Pattern Recognition (PR)**_, vol. 179, pp. 113510, **2026**. [\[Paper\]](https://www.sciencedirect.com/science/article/pii/S0031320326004760) (\*Co-corresponding author)

[47] Yunfei Luan, Yating Luo, Yuxuan Liu, Musen Zhang, Yujian An, Jianxin Yang, **Yao Guo\***, and Guang-Zhong Yang\*, "Autofocusing with Three-Dimensional Tracking for Robot-Assisted Microsurgery", _**IEEE/ASME Transactions on Mechatronics (TMECH)**_, vol. 31, no. 1, pp. 220-231, **2026**. [\[Paper\]](https://ieeexplore.ieee.org/document/11091590)[\[Code\]](https://github.com/IMR-PCB/3DTracking) (\*Co-corresponding author)

<span style="color:blue">**2025**</span>

[46] Bingze He, **Yao Guo\***, and Guang-Zhong Yang\*, "Integrated Piezoelectric Vibration and In-Situ Force Sensing for Low-Trauma Tissue Penetration", _**Cyborg and Bionic Systems (CBS)**_, vol. 6, pp. 4017, **2025**. [\[Paper\]](https://spj.science.org/doi/10.34133/cbsystems.0417) (\*Co-corresponding author, <span style="color:red">**Cover Article**</span>)

[45] Yuxuan Liu, Jiasheng Zhou, Yating Luo, Sung-Liang Chen, **Yao Guo\*** and Guang-Zhong Yang\*, "FPM-R2Net: Fused Photoacoustic and Operating Microscopic Imaging with Cross-modality Representation and Registration Network", _**Medical Image Analysis (MEDIA)**_, vol. 105, pp. 103698, **2025**. [\[Paper\]](https://www.sciencedirect.com/science/article/abs/pii/S1361841525002452)[\[Code\]](https://github.com/IMR-PCB/FPM-R2Net) (\*Co-corresponding author)

[44] Jianxin Yang, Yuxuan Liu, Jinkai Li, Xiao Gu, Guang-Zhong Yang, and **Yao Guo\***, "PoseSDF++: Point Cloud-Based 3-D Human Pose Estimation via Implicit Neural Representation", _**IEEE Transactions on Industrial Informatics (TII)**_, vol. 21, no. 3, pp. 2689-2698, **2025**. [\[Paper\]](https://ieeexplore.ieee.org/document/10811749) (\*Corresponding author)

[43] Yujian An, Bingze He, Zhuochen Ma, **Yao Guo\*** and Guang-Zhong Yang\*, "Microassembly: A Review on Fundamentals, Applications and Recent Developments", _**Engineering**_, vol. 48, pp. 323-346, **2025**. [\[Paper\]](sciencedirect.com/science/article/pii/S2095809924006350) (\*Co-corresponding author)

[42] Yuxuan Liu, Yating Luo, Yunfei Luan, Xinyao Zhou, Jianxin Yang, **Yao Guo\***, and Guang-Zhong Yang\*, "Towards Accurate Brain Electrode Implantation via Cross-modality Fusion of White-light and Photoacoustic Microscopy", _**IEEE/RSJ International Conference on Intelligent Robots and Systems (IROS)**_, Hangzhou, China, **2025**, pp. 7726-7732. [\[Paper\]](https://ieeexplore.ieee.org/document/11247750) (\*Co-corresponding author)

[41] Xinyao Zhou†, Yuxuan Liu†, Musen Zhang, Jinkai Li, **Yao Guo\***, and Guang-Zhong Yang\*, "Deep Coarse-to-Fine Networks for Robust Segmentation and Pose Estimation of Surgical Suturing Threads", _**IEEE/RSJ International Conference on Intelligent Robots and Systems (IROS)**_, Hangzhou, China, **2025**, pp. 520-526. [\[Paper\]](https://ieeexplore.ieee.org/document/11246693) (\*Co-corresponding author)

[40] Yiming Zhai†, Jingsong Liu†, Yating Luo*, Ziwei Wang, and **Yao Guo\***, "Adaptive Motion Scaling in Teleoperated Robotic Surgery based on Human Intention and Attention", _**IEEE/RSJ International Conference on Intelligent Robots and Systems (IROS)**_, Hangzhou, China, **2025**, pp. 15489-15495. [\[Paper\]](https://ieeexplore.ieee.org/document/11246262) (\*Co-corresponding author)

[39] Tianshu Zhao†, Zhenye Xu†, Pu Wang*, and **Yao Guo\***, "Hybrid Learning-based Balance Function Assessment of Stroke Patients with a Single Ear-Worn IMU", _**IEEE/RSJ International Conference on Intelligent Robots and Systems (IROS)**_, Hangzhou, China, **2025**, pp. 16373-16378. [\[Paper\]](https://ieeexplore.ieee.org/document/11246562) (\*Co-corresponding author)
...
[37] Yujian An, Jianxin Yang, Bingze He, Yuxuan Liu, **Yao Guo\*** and Guang-Zhong Yang\*, "A Microscopic Vision-Based Robotic System For Floating Electrode Assembly", _**IEEE/ASME Transactions on Mechatronics (TMECH)**_, vol. 29, no. 5, pp. 3810-3820, **2024**. [\[Paper\]](https://ieeexplore.ieee.org/document/10440627) (\*Co-corresponding author)

[36] Yuxuan Liu, Jiasheng Zhou, Yating Luo, Jinkai Li, Sung-Liang Chen, **Yao Guo\*** and Guang-Zhong Yang\*, "UPAMNet: A unified network with deep knowledge priors for photoacoustic microscopy", _**Photoacoustics**_, vol. 38, pp. 100608, **2024**. [\[Paper\]](https://www.sciencedirect.com/science/article/pii/S2213597924000259)[\[Code\]](https://github.com/IMR-PCB/UPAMNet) (\*Co-corresponding author)
...
[31] Yunfei Luan†, Muhang He†, Yudong Tian, Chengjie Lin, Yunhan Fang, Zihao Zhao, Jianxin Yang, **Yao Guo\***, "Intelligent Disinfection Robot with High-Touch Surface Detection and Dynamic Pedestrian Avoidance”, _**IEEE International Conference on Robotics and Automation (ICRA)**_, Yokohoma, Japan, **2024**, pp. 3595-3601. [\[Paper\]](https://ieeexplore.ieee.org/document/10610836) (\*Corresponding author)
...
[29] Frank Lo, **Yao Guo\***, Yingnan Sun, Jianing Qiu, Benny Lo, "An Intelligent Vision-Based Nutritional Assessment Method for Handheld Food Items", IEEE Transactions on Multimedia (TMM), 2023, vol. 25, pp. 5840 - 5851. [Paper] (\*Corresponding author)

[28] Jinkai Li, Jianxin Yang, Yuxuan Liu, ZHEN LI, Guang-Zhong Yang, **Yao Guo\***, "EasyGaze3D: Towards Effective and Flexible 3D Gaze Estimation from a Single RGB Camera ", IEEE/RSJ International Conference on Intelligent Robots and Systems (IROS), Dec. 2023, pp. 6537-6543. [Paper] [Code] (\*Corresponding author，Finalists of Best Paper Award on Cognitive Robotics)
